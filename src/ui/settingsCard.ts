...
class SettingsCard {
   ...
   */
  createSettingsCard(): GoogleAppsScript.Card_Service.Card {
   ...
   */
  handleAnalyticsToggle(e: any): GoogleAppsScript.Card_Service.ActionResponse {
    const analytics = PostHogAnalytics.getInstance();
   ...
   * @returns CardService.ActionResponse The action response
   */
  resetAllSettings(): GoogleAppsScript.Card_Service.ActionResponse {
    ...
    return CardService.newActionResponseBuilder()
      ...
      .setNavigation(
        CardService.newNavigation()
          .popToRoot()
          .updateCard(this.createSettingsCard())
      )
      .build();
  }
}
